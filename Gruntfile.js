      ...
      dev: {
        options: {
          ...
          processName: function(filePath) {
            return filePath.split('assets/js/app/aura_components/')[1].split('.hbs')[0];
          }
        },
        files: {
          "assets/js/app/templates/templates-compiled.js": ["assets/js/app/aura_components/**/*.hbs"]
        }
      }
    },
    ...
    watch: {
      ...
      assets: {
        ...
        files: [
          ...
          '!assets/js/app/bower_components'
        ],
